...
const HeroSection = () => {
  return (
    <div className="bg-gray-50 min-h-[600px] my-20 max-w-[1400px] mx-auto rounded-2xl flex items-center relative overflow-hidden">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              ...
              <Link href="/all-products">
                <button className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-lg transition duration-300 transform hover:scale-105">
                  Explore
                </button>
              </Link>

              <button className="w-full sm:w-auto px-8 py-4 bg-white border-2 border-gray-200 hover:border-blue-600 text-gray-700 hover:text-blue-600 font-semibold rounded-lg transition duration-300">
                View Fleet
              </button>
            </div>
          ...
          <div className="w-full lg:w-1/2 relative z-10">
            ...
            <div className="absolute -bottom-6 -left-6 md:bottom-10 md:-left-10 bg-white p-4 rounded-lg shadow-xl border border-gray-100 hidden md:block">
              ...
              <p className="text-2xl font-bold text-gray-900">
                $45.00 <span className="text-sm font-normal text-gray-500">/day</span>
              </p>
            </div>
          </div>
