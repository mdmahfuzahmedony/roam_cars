...
const WhyChoose = () => {
  return (
    <section className="bg-base-500 max py-16 md:py-24">
      <div className="container mx-auto px-4 max-w-[1400px]">
        {/* Main Title of the Section */}
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-12 md:mb-16 text-center md:text-left">
          Why Choose Us?
        </h2>

        {/* Grid for Feature Items */}
        <div className="grid grid-cols-1   rounded-4xl sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          {features.map((feature, index) => (
            // Each Feature Item
            <div key={index} className="flex bg-base-200 rounded-4xl flex-col items-center text-center p-4">
              {/* Icon */}
